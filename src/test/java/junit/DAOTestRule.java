...
/**
 * Created by Sunil Kata on 10/24/2016.
 */
...
public class DAOTestRule extends ExternalResource {
    ...
    public static class Builder {
        ...
        private String url = "jdbc:h2:mem:" + UUID.randomUUID() +
                "INIT=CREATE SCHEMA IF NOT EXISTS TEMPLATE\\;";
        private String username = "sa";
        private String password = "";
        private String driver = "org.h2.Driver";
        private String hbm2ddlAuto = "create";
        private String hbm2ddlImport =  "h2/TEMPLATE_DDL.sql,"+
                                        "h2/test_table.sql";
        ...
        public DAOTestRule build() {
            ...
            config.setProperty(AvailableSettings.HBM2DDL_IMPORT_FILES, hbm2ddlImport);
